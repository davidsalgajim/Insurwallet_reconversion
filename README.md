...
| Worker           | `WORKER_URL`, `INTERNAL_API_SECRET` (**requerido en local**), `WORKER_REQUEST_TIMEOUT_MS` (default 5 min), `GOOGLE_APPLICATION_CREDENTIALS` o `FIREBASE_SERVICE_ACCOUNT`, `WORKER_OIDC_AUDIENCE` (prod)               |
